  ...
  <div className={`rounded-2xl border border-slate-200/90 bg-white p-6 shadow-sm sm:p-7 ${className}`.trim()}>
    <div className="flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
      <div className="max-w-2xl">
        ...
        <h2 className="mt-1 text-lg font-semibold tracking-tight text-slate-900">
          Generate the final comic page
        </h2>
        <p className="mt-2 text-sm leading-relaxed text-slate-500">
          When the character sheet and storyboard are ready, the parent flow can render
          the finished page here and expose download behavior through props.
        </p>
      </div>
      ...
      <div className="flex w-full flex-col gap-3 sm:w-auto sm:flex-row">
        ...
        >
          ...
          {isGenerating ? 'Generating comic...' : 'Generate comic page'}
        </button>
    ...
    <div className="mt-6 overflow-hidden rounded-2xl border border-slate-200 bg-slate-50/80 shadow-inner">
      {pageImage ? (
        <img
          src={pageImage}
          alt="Generated comic page preview"
        ...
        <div className="flex min-h-[420px] items-center justify-center bg-gradient-to-br from-slate-50 via-white to-violet-50/50 p-8">
          <div className="max-w-sm text-center">
            ...
            <p className="mt-2 text-sm leading-relaxed text-slate-500">
              The generated 2x2 comic page will appear here once the parent calls the
              generation hook and stores the resulting image.
            </p>
          </div>
        </div>
      )}
