...
const STYLE_PREVIEW_IMAGE_MAP: Partial<Record<keyof typeof STYLE_PRESETS, string>> = {
  ...
  kidDoodle: resolvePublicAssetPath('style-previews/kidDoodle.png'),
  gouache: resolvePublicAssetPath('style-previews/Gouache.png'),
  lineChibi: resolvePublicAssetPath('style-previews/lineChibi.png'),
  studioGhibli: resolvePublicAssetPath('style-previews/studioGhibli.png'),
  akiraToriyama: resolvePublicAssetPath('style-previews/akiraToriyama.png'),
  eiichiroOda: resolvePublicAssetPath('style-previews/eiichiroOda.png'),
  makotoShinkai: resolvePublicAssetPath('style-previews/makotoShinkai.png'),
  clamp: resolvePublicAssetPath('style-previews/clamp.png'),
  hirohikoAraki: resolvePublicAssetPath('style-previews/hirohikoAraki.png'),
  takehikoInoue: resolvePublicAssetPath('style-previews/takehikoInoue.png'),
  kyotoAnimation: resolvePublicAssetPath('style-previews/kyotoAnimation.png'),
  ufotable: resolvePublicAssetPath('style-previews/ufotable.png'),
  trigger: resolvePublicAssetPath('style-previews/trigger.png'),
  kentaroMiura: resolvePublicAssetPath('style-previews/kentaroMiura.png'),
  rumikoTakahashi: resolvePublicAssetPath('style-previews/rumikoTakahashi.png'),
  osamuTezuka: resolvePublicAssetPath('style-previews/osamuTezuka.png'),
  katsuhiroOtomo: resolvePublicAssetPath('style-previews/katsuhiroOtomo.png'),
  taiyoMatsumoto: resolvePublicAssetPath('style-previews/taiyoMatsumoto.png'),
  yoshitakaAmano: resolvePublicAssetPath('style-previews/yoshitakaAmano.png'),
  tsutomuNihei: resolvePublicAssetPath('style-previews/tsutomuNihei.png'),
  masamuneShirow: resolvePublicAssetPath('style-previews/masamuneShirow.png'),
  mamoruNagano: resolvePublicAssetPath('style-previews/mamoruNagano.png'),
  shinichiroWatanabe: resolvePublicAssetPath('style-previews/shinichiroWatanabe.png'),
  masaakiYuasa: resolvePublicAssetPath('style-previews/masaakiYuasa.png'),
  posukaDemizu: resolvePublicAssetPath('style-previews/posukaDemizu.png'),
  yoshiyukiSadamoto: resolvePublicAssetPath('style-previews/yoshiyukiSadamoto.png'),
  yusukeMurata: resolvePublicAssetPath('style-previews/yusukeMurata.png'),
  sumiE: resolvePublicAssetPath('style-previews/sumiE.png'),
};
