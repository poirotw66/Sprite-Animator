...
const STYLE_PREVIEW_PLACEHOLDER_LABELS: Record<keyof typeof STYLE_PRESETS, string> = {
  ...
  akiraToriyama: 'Akira Toriyama',
  eiichiroOda: 'Eiichiro Oda',
  ...
  rumikoTakahashi: 'Rumiko Takahashi',
  osamuTezuka: 'Osamu Tezuka',
  katsuhiroOtomo: 'Katsuhiro Otomo',
  taiyoMatsumoto: 'Taiyo Matsumoto',
  yoshitakaAmano: 'Yoshitaka Amano',
  tsutomuNihei: 'Tsutomu Nihei',
  masamuneShirow: 'Masamune Shirow',
  mamoruNagano: 'Mamoru Nagano',
  shinichiroWatanabe: 'Shinichiro Watanabe',
  masaakiYuasa: 'Masaaki Yuasa',
  posukaDemizu: 'Posuka Demizu',
  yoshiyukiSadamoto: 'Yoshiyuki Sadamoto',
  yusukeMurata: 'Yusuke Murata',
  sumiE: 'Sumi-e',
};
...
const STYLE_PREVIEW_IMAGE_MAP: Partial<Record<keyof typeof STYLE_PRESETS, string>> = {
  chibi: resolvePublicAssetPath('style-preview-thumbnails/chibi.webp'),
  pixel: resolvePublicAssetPath('style-preview-thumbnails/pixel.webp'),
  minimalist: resolvePublicAssetPath('style-preview-thumbnails/minimalist.webp'),
  anime: resolvePublicAssetPath('style-preview-thumbnails/anime.webp'),
  cartoon: resolvePublicAssetPath('style-preview-thumbnails/cartoon.webp'),
  watercolor: resolvePublicAssetPath('style-preview-thumbnails/watercolor.webp'),
  yurukawa: resolvePublicAssetPath('style-preview-thumbnails/yurukawa.webp'),
  pastel: resolvePublicAssetPath('style-preview-thumbnails/pastel.webp'),
  flat: resolvePublicAssetPath('style-preview-thumbnails/flat.webp'),
  doodle: resolvePublicAssetPath('style-preview-thumbnails/doodle.webp'),
  kidDoodle: resolvePublicAssetPath('style-preview-thumbnails/kidDoodle.webp'),
  gouache: resolvePublicAssetPath('style-preview-thumbnails/Gouache.webp'),
  lineChibi: resolvePublicAssetPath('style-preview-thumbnails/lineChibi.webp'),
  studioGhibli: resolvePublicAssetPath('style-preview-thumbnails/studioGhibli.webp'),
  akiraToriyama: resolvePublicAssetPath('style-preview-thumbnails/akiraToriyama.webp'),
  eiichiroOda: resolvePublicAssetPath('style-preview-thumbnails/eiichiroOda.webp'),
  makotoShinkai: resolvePublicAssetPath('style-preview-thumbnails/makotoShinkai.webp'),
  clamp: resolvePublicAssetPath('style-preview-thumbnails/clamp.webp'),
  hirohikoAraki: resolvePublicAssetPath('style-preview-thumbnails/hirohikoAraki.webp'),
  takehikoInoue: resolvePublicAssetPath('style-preview-thumbnails/takehikoInoue.webp'),
  kyotoAnimation: resolvePublicAssetPath('style-preview-thumbnails/kyotoAnimation.webp'),
  ufotable: resolvePublicAssetPath('style-preview-thumbnails/ufotable.webp'),
  trigger: resolvePublicAssetPath('style-preview-thumbnails/trigger.webp'),
  kentaroMiura: resolvePublicAssetPath('style-preview-thumbnails/kentaroMiura.webp'),
  rumikoTakahashi: resolvePublicAssetPath('style-preview-thumbnails/rumikoTakahashi.webp'),
  osamuTezuka: resolvePublicAssetPath('style-preview-thumbnails/osamuTezuka.webp'),
  katsuhiroOtomo: resolvePublicAssetPath('style-preview-thumbnails/katsuhiroOtomo.webp'),
  taiyoMatsumoto: resolvePublicAssetPath('style-preview-thumbnails/taiyoMatsumoto.webp'),
  yoshitakaAmano: resolvePublicAssetPath('style-preview-thumbnails/yoshitakaAmano.webp'),
  tsutomuNihei: resolvePublicAssetPath('style-preview-thumbnails/tsutomuNihei.webp'),
  masamuneShirow: resolvePublicAssetPath('style-preview-thumbnails/masamuneShirow.webp'),
  mamoruNagano: resolvePublicAssetPath('style-preview-thumbnails/mamoruNagano.webp'),
  shinichiroWatanabe: resolvePublicAssetPath('style-preview-thumbnails/shinichiroWatanabe.webp'),
  masaakiYuasa: resolvePublicAssetPath('style-preview-thumbnails/masaakiYuasa.webp'),
  posukaDemizu: resolvePublicAssetPath('style-preview-thumbnails/posukaDemizu.webp'),
  yoshiyukiSadamoto: resolvePublicAssetPath('style-preview-thumbnails/yoshiyukiSadamoto.webp'),
  yusukeMurata: resolvePublicAssetPath('style-preview-thumbnails/yusukeMurata.webp'),
  sumiE: resolvePublicAssetPath('style-preview-thumbnails/sumiE.webp'),
};
        ...
        {(config.includeText || config.textRendering === 'programmatic') && (
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 animate-in fade-in slide-in-from-top-2 duration-300">
            ...
            <div className="md:col-span-2 rounded-xl border border-slate-200 bg-white p-3 shadow-inner">
              ...
              <img
                src={resolvePublicAssetPath('font.webp')}
                alt=""
                width={1408}
                height={768}
                loading="lazy"
