...
export const useLineStickerWorkspace = () => {
    ...
    const {
        ...
        jobImageState, replaceImagesFromJobSheets,
    ...
    return {
        ...
        resume: {
            ...
            onDismissHydrateIssue: dismissHydrateIssue,
            ...
            hydrateMissingLabel: lineStickerT.lineStickerHydrateMissing,
            hydrateFailedLabel: lineStickerT.lineStickerHydrateFailed,
        },
        settings: {
            t: lineStickerT,
