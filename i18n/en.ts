...
export const en: Translations = {
  ...
  lineStickerDescLabel: 'Character Description (Optional)',
  lineStickerDescPlaceholder: 'Describe the character personality, e.g.: cute, tsundere, cheerful...',
  lineStickerDescHint: 'Leave empty to use default: cute, calm, gentle, slightly mischievous',
