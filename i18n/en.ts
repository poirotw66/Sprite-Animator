...
export const en: Translations = {
  ...
  autoSliceLowConfidence: 'Auto slice confidence is low. You can apply this suggestion once and keep previewing.',
  autoSliceSuggestedAdjustment: 'Suggestion: {cols}x{rows}, X {shiftX}, Y {shiftY}',
  ...
  lineStickerPhraseInteraction: 'Social interaction',
