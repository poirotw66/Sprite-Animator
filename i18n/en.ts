...
export const en: Translations = {
  ...
  registryLoadedFromOutput: 'Loaded from output/sticker-registry.json',
  registryLoadOutputHint: 'Could not auto-load output/ (upload JSON or run npm run dev locally)',
  ...
  registryPreviewHint: 'Previews require local dev server (output/ static hosting)',
  registrySelectRow: 'Select a row to view details',
  registryEmpty: 'Upload sticker-registry.json or run the dev server locally',
