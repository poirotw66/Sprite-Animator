...
export const en: Translations = {
  ...
  sliceModeManualHint:
    'Starts with no cuts. Choose Vertical/Horizontal to add lines; Delete to remove. Drag existing lines to move them.',
  ...
  sliceModeManualHintDelete: 'Delete mode: click a cut to remove · Alt/right-click also works',
