...
export const en: Translations = {
  ...
  sliceModeManual: 'Draw lines',
  sliceModeManualHint:
    'Starts from an equal grid matching current cols×rows. Click to add, drag to move, or delete cuts. Shortcuts: V vertical · H horizontal · X delete · Ctrl+Z undo. Hold Alt to disable snap.',
  sliceModeManualHintVertical: 'Vertical mode: click to add · drag lines to move',
  sliceModeManualHintHorizontal: 'Horizontal mode: click to add · drag lines to move',
  sliceModeManualHintDelete: 'Delete mode: click a cut to remove · right-click also works',
  sliceModeManualDraw: 'Tool',
  sliceModeManualVertical: 'Vertical',
  sliceModeManualHorizontal: 'Horizontal',
  sliceModeManualDelete: 'Delete',
  sliceModeManualClear: 'Clear lines',
  sliceModeManualSeedEqual: 'Reset equal',
  sliceModeManualUndo: 'Undo',
  sliceModeManualRedo: 'Redo',
  sliceModeManualHotkeys: 'V / H / X · Ctrl+Z',
  sliceModeRects: 'Box select',
  sliceModeRectsHint:
    'Drag rectangles on the sheet; each box becomes one frame. Move, resize by handles, or Delete the selection. Shortcuts: D draw · X delete mode · Ctrl+Z undo.',
  sliceModeRectsHintDraw: 'Draw mode: drag empty space to add · select to move or resize',
  sliceModeRectsHintDelete: 'Delete mode: click a box to remove · right-click also works',
  sliceModeRectsDraw: 'Draw box',
  sliceModeRectsDelete: 'Delete box',
  sliceModeRectsClear: 'Clear all',
  sliceModeRectsHotkeys: 'D / X · Ctrl+Z · Del',
  partingDrawHint: 'Draw vertical and horizontal cuts on the sheet; cell count follows your lines and the frame grid updates live.',
  partingRectsHint: 'Box each character or sticker on the sheet; box order = frame order and the grid updates live.',
  partingModeEqual: 'Equal grid',
  partingModeOwnership: 'Smart slice',
  partingModeManual: 'Draw lines',
  partingModeRects: 'Box select',
  ...
  localDevelopmentKeyDetected: 'Local development key detected (can override)',
  ...
  errorBoundarySubtitle: 'The app hit an unexpected error',
  errorBoundaryMessageLabel: 'Error message:',
  errorBoundaryChunkReload: 'The app may have been updated. Refresh the page (F5 or Cmd+R) to load the latest version.',
  errorBoundaryStackSummary: 'View stack trace',
  errorBoundaryRetry: 'Try again',
  errorBoundaryReload: 'Reload page',
  errorBoundaryHint: 'If the problem persists, clear your browser cache or contact support.',

  registryTool: 'Sticker Production Registry',
  registryToolDesc: 'Browse daily-pack sticker-registry and batch plans; track characters, themes, and status',
  registryTitle: 'Sticker Production Registry',
  registrySubtitle: 'Load output/sticker-registry.json or batch-plan.json. Local dev server can auto-fetch from output/',
  registryUploadRegistry: 'Upload registry JSON',
  registryUploadBatchPlan: 'Upload batch-plan JSON',
  registryReloadOutput: 'Reload from output/',
  registryLoadedFromVault: 'Loaded from line-sticker-vault/registry/sticker-registry.json',
  registryLoadVaultHint: 'Could not load vault (ensure ../line-sticker-vault exists and run npm run dev, or upload registry JSON)',
  registryParseError: 'Could not parse JSON file',
  registryStatTotal: 'Total sets',
  registryStatB: 'B new',
  registryStatA: 'A rotate',
  registryStatCompleted: 'Completed',
  registryStatPlanned: 'Planned',
  registryStatFailed: 'Failed',
  registryStatCharacters: 'Characters',
  registryBatchPlanTitle: 'Daily batch plan',
  registryBatchPlanMeta: '{count} sets (B {b} / A {a}, ratio {ratio})',
  registryFilterAllBatch: 'All plans',
  registryFilterB: 'B only',
  registryFilterA: 'A only',
  registryFilterAllStatus: 'All statuses',
  registryFilterAllDates: 'All dates',
  registryStatusCompleted: 'Completed',
  registryStatusPlanned: 'Planned',
  registryStatusFailed: 'Failed',
  registrySearchPlaceholder: 'Search character, theme, path…',
  registryColId: 'ID',
  registryColCharacter: 'Character',
  registryColBatch: 'Plan',
  registryColTheme: 'Theme',
  registryColVoice: 'Voice',
  registryColStatus: 'Status',
  registryNoEntries: 'No matching entries',
  registryDetailConcept: 'Concept',
  registryDetailStyle: 'Style',
  registryDetailDate: 'Date',
  registryDetailOutput: 'Output path',
  registryDetailRef: 'Reference',
  registryDetailSticker: 'Sticker preview',
  registryPreviewHint: 'Previews require local dev server (/vault/ static hosting)',
  registrySelectRow: 'Select a row to view details',
  registryEmpty: 'Ensure line-sticker-vault is cloned as a sibling folder, or upload sticker-registry.json',
  registryTabCharacters: 'Character refs',
  registryTabThemeSets: 'Theme phrase sets',
  registryCharactersSubtitle: 'Character model sheets and concepts (B-plan sources)',
  registryThemeSetsSubtitle: 'Theme, voice, and phrase-set.json per sticker pack',
  registryUploadPhraseSet: 'Upload phrase-set JSON',
  registryCharacterSets: 'Linked sets',
  registryCharacterThemes: 'Themes used',
  registryPhraseSetName: 'Set name',
  registryPhraseSetPhrases: 'Captions',
  registryPhraseSetVisualOnly: 'Visual-only',
  registryPhraseSetLoadError: 'Could not load phrase-set.json',
  registryPhraseSetLoading: 'Loading phrases…',
  registryPhraseSetSample: 'Phrase preview',
  registryPhraseSetRawJson: 'Raw JSON',
  registryThemeSetPath: 'phrase-set path',
  registryNoCharacters: 'No matching characters',
  registrySelectCharacter: 'Select a character card to view details',
  registrySelectThemeSet: 'Select a set to view phrase-set',
  ...
  lineStickerHydrating: 'Restoring your previous sticker job…',
