...
export interface Translations {
  ...
  center: string;
  dragHint: string;
  sliceModeEqual: string;
  sliceModeOwnership: string;
  sliceModeOwnershipHint: string;
  sliceModeManual: string;
  sliceModeManualHint: string;
  sliceModeManualHintVertical: string;
  sliceModeManualHintHorizontal: string;
  sliceModeManualHintDelete: string;
  sliceModeManualDraw: string;
  sliceModeManualVertical: string;
  sliceModeManualHorizontal: string;
  sliceModeManualDelete: string;
  sliceModeManualClear: string;
  sliceModeManualSeedEqual: string;
  sliceModeManualUndo: string;
  sliceModeManualRedo: string;
  sliceModeManualHotkeys: string;
  sliceModeRects: string;
  sliceModeRectsHint: string;
  sliceModeRectsHintDraw: string;
  sliceModeRectsHintDelete: string;
  sliceModeRectsDraw: string;
  sliceModeRectsDelete: string;
  sliceModeRectsClear: string;
  sliceModeRectsHotkeys: string;
  partingDrawHint: string;
  partingRectsHint: string;
  partingModeEqual: string;
  partingModeOwnership: string;
  partingModeManual: string;
  partingModeRects: string;
  ...
  registryStatA: string;
  registryStatCompleted: string;
  registryStatPlanned: string;
  registryStatFailed: string;
  registryStatCharacters: string;
  registryBatchPlanTitle: string;
  registryBatchPlanMeta: string;
  registryFilterAllBatch: string;
  registryFilterB: string;
  registryFilterA: string;
  registryFilterAllStatus: string;
  registryFilterAllDates: string;
  registryStatusCompleted: string;
  registryStatusPlanned: string;
  registryStatusFailed: string;
  registrySearchPlaceholder: string;
  registryColId: string;
  registryColCharacter: string;
  registryColBatch: string;
  registryColTheme: string;
  registryColVoice: string;
  registryColStatus: string;
  registryNoEntries: string;
  registryDetailConcept: string;
  registryDetailStyle: string;
  registryDetailDate: string;
  registryDetailOutput: string;
  registryDetailRef: string;
  registryDetailSticker: string;
  registryPreviewHint: string;
  registrySelectRow: string;
  registryEmpty: string;
  registryTabCharacters: string;
  registryTabThemeSets: string;
  registryCharactersSubtitle: string;
  registryThemeSetsSubtitle: string;
  registryUploadPhraseSet: string;
  registryCharacterSets: string;
  registryCharacterThemes: string;
  registryPhraseSetName: string;
  registryPhraseSetPhrases: string;
  registryPhraseSetVisualOnly: string;
  registryPhraseSetLoadError: string;
  registryPhraseSetLoading: string;
  registryPhraseSetSample: string;
  registryPhraseSetRawJson: string;
  registryThemeSetPath: string;
  registryNoCharacters: string;
  registrySelectCharacter: string;
  registrySelectThemeSet: string;

  // One-Page Comic
  comicTitle: string;
  comicWizardEyebrow: string;
  comicWizardTitle: string;
  comicStepCounter: string;
  comicStepSource: string;
  comicStepSourceHelper: string;
  comicStepSheet: string;
  comicStepSheetHelper: string;
  comicStepStoryboard: string;
  comicStepStoryboardHelper: string;
  comicStepGenerate: string;
  comicStepGenerateHelper: string;
  comicSourceTitle: string;
  comicSourceDescription: string;
  comicSourceUpload: string;
  comicSourceConcept: string;
  comicConceptLabel: string;
  comicConceptPlaceholder: string;
  comicUploadTipsTitle: string;
  comicUploadTipSingleCharacter: string;
  comicUploadTipBodyFraming: string;
  comicUploadTipReadableDetails: string;
  comicUploadTipOptionalConcept: string;
  comicConceptCardTitle: string;
  comicConceptCardDescription: string;
  comicConceptPromptAppearance: string;
  comicConceptPromptPersonality: string;
  comicConceptPromptItems: string;
  comicStyleLabel: string;
  comicSheetDescription: string;
  comicSelectedStyleDetails: string;
  comicStyleDetailLabel: string;
  comicStyleDetailType: string;
  comicStyleDetailMethod: string;
  comicSheetPreviewTitle: string;
  comicSheetPreviewDescription: string;
  comicSheetReady: string;
  comicSheetEmptyTitle: string;
  comicSheetEmptyDescription: string;
  comicGenerateSheet: string;
  comicGeneratingSheet: string;
  ...
  comicFillingStoryboard: string;
  comicStoryboardDescription: string;
  comicPanelTitlePrefix: string;
  comicPanelTopLeft: string;
  comicPanelTopRight: string;
  comicPanelBottomLeft: string;
  comicPanelBottomRight: string;
  comicPanelSceneLabel: string;
  comicPanelScenePlaceholder: string;
  comicPanelDialogueLabel: string;
  comicPanelCameraLabel: string;
  comicPanelCameraPlaceholder: string;
  comicLayoutBadge: string;
  comicGeneratePage: string;
  comicGeneratingPage: string;
  comicRegeneratePage: string;
  comicDownloadPng: string;
  comicResultDescription: string;
  comicPagePreviewTitle: string;
