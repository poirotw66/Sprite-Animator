...
export const zhTW: Translations = {
  ...
  sliceModeManual: '畫線切分',
  sliceModeManualHint:
    '進入後以目前格數產生等分切線，可再點圖新增、拖曳移動或刪除。快捷鍵：V 豎線 · H 橫線 · X 刪除 · Ctrl+Z 復原。按住 Alt 關閉吸附。',
  sliceModeManualHintVertical: '豎線模式：點一下新增豎線 · 可拖曳既有切線',
  sliceModeManualHintHorizontal: '橫線模式：點一下新增橫線 · 可拖曳既有切線',
  sliceModeManualHintDelete: '刪除模式：點切線刪除 · 也可右鍵刪除',
  sliceModeManualDraw: '工具',
  sliceModeManualVertical: '豎線',
  sliceModeManualHorizontal: '橫線',
  sliceModeManualDelete: '刪除線',
  sliceModeManualClear: '清空切線',
  sliceModeManualSeedEqual: '重設等分',
  sliceModeManualUndo: '復原',
  sliceModeManualRedo: '重做',
  sliceModeManualHotkeys: 'V / H / X · Ctrl+Z',
  sliceModeRects: '框選切分',
  sliceModeRectsHint:
    '在圖上拖曳畫出矩形框，每個框成為一幀。可拖移、拉角縮放；Delete 刪除選取框。快捷鍵：D 畫框 · X 刪除模式 · Ctrl+Z 復原。',
  sliceModeRectsHintDraw: '畫框模式：空白處拖曳新增 · 點選後可拖移或拉角縮放',
  sliceModeRectsHintDelete: '刪除模式：點框刪除 · 也可右鍵刪除',
  sliceModeRectsDraw: '畫框',
  sliceModeRectsDelete: '刪除框',
  sliceModeRectsClear: '清空全部',
  sliceModeRectsHotkeys: 'D / X · Ctrl+Z · Del',
  partingDrawHint: '在圖上畫豎線與橫線來切分；切線決定格數，右側會即時更新。',
  partingRectsHint: '在圖上直接框出每個角色／貼圖；框的順序＝幀順序，右側會即時更新。',
  partingModeEqual: '等分網格',
  partingModeOwnership: '智慧切分',
  partingModeManual: '畫線切分',
  partingModeRects: '框選切分',
  ...
  localDevelopmentKeyDetected: '已檢測到本機開發 Key（可覆蓋）',
  ...
  errorBoundarySubtitle: '應用程式遇到了一個意外錯誤',
  errorBoundaryMessageLabel: '錯誤訊息：',
  errorBoundaryChunkReload: '程式可能已更新。請重新整理頁面 (F5 或 Cmd+R) 以載入最新版本。',
  errorBoundaryStackSummary: '查看詳細堆疊資訊',
  errorBoundaryRetry: '重試',
  errorBoundaryReload: '重新載入頁面',
  errorBoundaryHint: '若問題持續，請清除瀏覽器快取或聯絡技術支援。',
  ...
  registryLoadedFromVault: '已從 line-sticker-vault/registry/sticker-registry.json 載入',
  registryLoadVaultHint: '無法載入 vault（請確認 ../line-sticker-vault 存在並執行 npm run dev，或手動上傳 registry JSON）',
  ...
  registryPreviewHint: '預覽需在本機 dev server 執行（/vault/ 靜態服務）',
  registrySelectRow: '點選左側列以檢視詳情',
  registryEmpty: '請確認 line-sticker-vault 已 clone 為 sibling 資料夾，或上傳 sticker-registry.json',
  ...
  lineStickerHydrating: '正在還原上一份貼圖作業…',
  ...
  lineStickerSheetCancelled: '已取消（重整中斷）',
