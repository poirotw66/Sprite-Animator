...
## Corpus Check
- 305 files · ~1,107,585 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2361 nodes · 5393 edges · 175 communities (118 shown, 57 thin omitted)
...
Cohesion: 0.15
Nodes (20): ApiError, getErrorMessage(), isApiError(), isQuotaError(), QuotaError, analyzeFrameContent(), ContentAnalysis, getContentCentroidOffset() (+12 more)
...
Cohesion: 0.10
Nodes (40): useLineStickerGeneration(), useLineStickerImageInput(), UseLineStickerImageInputParams, ColorKey, createEmptyOverlaySheetArray(), FontKey, LineStickerProgrammaticOverlayComposeResult, LineStickerProgrammaticOverlayCore (+32 more)
...
Cohesion: 0.14
Nodes (24): FrameGrid, FrameGridProps, LineStickerResultPanelViewerViewModel, LineStickerResultSidePhraseEdit, UseLineStickerResultPanelViewModelParams, SliceProcessedSheetOptions, useLineStickerSlicing(), UseLineStickerSlicingParams (+16 more)
