...
## Corpus Check
- 309 files · ~1,062,025 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2382 nodes · 5477 edges · 173 communities (116 shown, 57 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 38 edges (avg confidence: 0.8)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `6d8807b5`
...
## Communities (173 total, 57 thin omitted)

### Community 0 - "Gemini Prompt Builders"
Cohesion: 0.22
Nodes (14): useComicCharacterSheet(), useComicPageGeneration(), downloadDataUrl(), OnePageComicPage(), ComicFlowErrorKey, ComicFlowState, ComicPageGenerationState, getComicNextStepState() (+6 more)
...
Cohesion: 0.15
Nodes (22): FrameGrid, useSpriteSheet(), UseSpriteSheetSlicePipelineOptions, useSpriteSheetFlow(), DEFAULT_SLICE_SETTINGS, analyzeFrameContent(), ContentAnalysis, getContentCentroidOffset() (+14 more)
...
Cohesion: 0.14
Nodes (17): slotsAreDisjoint(), fontCssStackForPreset(), FontPresetKey, LineStickerTextOverlayOptions, luminance(), overlayPhrasesOnStickerFrames(), resolveProgrammaticFontFamilyCss(), TextColorPresetKey (+9 more)

### Community 5 - "Sticker Section UI"
Cohesion: 0.11
Nodes (36): LineStickerDownloadSection(), LineStickerDownloadSectionProps, LineStickerHeader(), LineStickerPhraseCell, LineStickerPhraseCellProps, LineStickerPhraseGridEditor, LineStickerPhraseGridEditorProps, LineStickerPhraseSection (+28 more)
...
Cohesion: 0.09
Nodes (50): StickerConfig, GenerateOneSheetParams, LineStickerProgrammaticStyleControls(), LineStickerProgrammaticStyleControlsProps, LineStickerSettingsConfigViewModel, LineStickerSettingsPanelViewModel, STYLE_PREVIEW_IMAGE_MAP, STYLE_PREVIEW_PLACEHOLDER_LABELS (+42 more)
...
Cohesion: 0.14
Nodes (29): useLineStickerGeneration(), useLineStickerImageInput(), UseLineStickerImageInputParams, useLineStickerPhraseGeneration(), ensureLength(), useLineStickerPhraseGrid(), UseLineStickerPhraseGridParams, useLineStickerPromptPreview() (+21 more)
...
Cohesion: 0.10
Nodes (38): decodeImage(), encodePng(), extForBytes(), isJpeg(), isPng(), RgbaImage, composePhraseOnRgbaFrame(), composePhrasesOnRgbaFrames() (+30 more)
...
Cohesion: 0.05
Nodes (54): normalizeChromaBackground(), SheetChromaKeyOptions, ChromaKeyAlgorithm, countGreenSpillNeighbors(), despillForgeGreenFringe(), distanceToGreenKey(), greenExcess(), isNearTransparency() (+46 more)
...
Cohesion: 0.11
Nodes (29): buildLineUploadPack(), buildLineUploadZipBytes(), buildUploadFile(), clampIndex(), encodeUploadZip(), LineUploadPackFile, pickRandomShopStickerIndices(), resolveShopStickerIndices() (+21 more)

### Community 20 - "Job Finalization Scripts"
Cohesion: 0.15
Nodes (18): args, buildUploadPackOptions(), FINALIZE_PROJECT_ROOT, finalizeFromJob(), FinalizeJobOptions, FinalizeJobResult, finalizeStickerJob(), JobManifest (+10 more)

### Community 21 - "Sticker Generation CLI"
Cohesion: 0.29
Nodes (11): generateComicCharacterSheet(), resolveComicStyleBlock(), generateComicPage(), isImageSizeRejection(), buildComicPagePrompt(), BuildComicPagePromptParams, panelBlock(), panels (+3 more)
...
Cohesion: 0.20
Nodes (20): generateStickerPhrases(), clampStickerPhrase(), clampStickerPhrases(), isEnglishPhraseLanguage(), ALLOWED_PUNCT, auditStickerPhrases(), cjkCharCount(), englishWordCount() (+12 more)
...
Cohesion: 0.10
Nodes (27): scoreSheetGrid(), decodePng(), detectBestGridLayout(), scoreGridLayout(), chromaKeyColor, cols, detected, expected (+19 more)
...
Cohesion: 0.20
Nodes (19): asDomCanvasContext(), composeStickerFrame(), cropFrame(), drawGlyph(), drawLineWithSpacing(), drawRgbaFrameOnCanvas(), ensureLandscapeStickerFrame(), measureOpaqueBounds() (+11 more)
...
Cohesion: 0.15
Nodes (19): ImageUpload, ImageUploadProps, LanguageSwitcher, LineStickerHeaderProps, useLanguage(), DownloadFormat, mapWithConcurrency(), useLineStickerDownload() (+11 more)
...
Cohesion: 0.26
Nodes (13): FrameGridProps, LineStickerResultPanelViewerViewModel, UseLineStickerSheetGenerationOptions, SliceProcessedSheetOptions, UseLineStickerSlicingParams, UseSpriteSheetFlowOptions, UseSpriteSheetFlowResult, BgRemovalMethod (+5 more)
...
Cohesion: 0.16
Nodes (17): ProjectHistory, ProjectHistoryItem, ProjectHistoryItemProps, ProjectHistoryProps, SettingsModal, SheetSliceProgrammaticOverlayPanel(), deleteProjectItem(), loadList() (+9 more)
...
Cohesion: 0.15
Nodes (19): AnimationConfigPanel, AnimationConfigPanelProps, AnimationPreview, AnimationPreviewProps, ExampleSelector, ExampleSelectorProps, SettingsModalProps, useAnimation() (+11 more)
...
Cohesion: 0.20
Nodes (19): blitRgbaOntoCanvas(), ComposeOverlayOptions, FontPresetKey, overlayPhraseOnRgbaFrame(), ProgrammaticOverlayOptions, readRgbaFromCanvas(), TextColorPresetKey, BUNDLED_STICKER_FONT_FILES (+11 more)
...
Cohesion: 0.16
Nodes (20): captionBandPixelRectForLabel(), centerSearchBoundsForTextBoxInBand(), textOverlayAvoidancePadPx(), wrapLines(), AutoCaptionLayout, AutoCaptionLayoutParams, buildForegroundOverlapIndex(), CaptionCenterResult (+12 more)
...
Cohesion: 0.29
Nodes (7): ComposeStickerOptions, ComposeLayoutPreset, DEFAULT_PROGRAMMATIC_COMPOSE_CONFIG, DEFAULT_PROGRAMMATIC_TEXT_OVERLAY_TUNING, ProgrammaticComposeConfig, ProgrammaticFontFamilySource, ProgrammaticTextPlacementMode

### Community 118 - "geminiSheet.mts"
Cohesion: 0.07
Nodes (63): AttachmentIndices, buildCharacterRefBlock(), buildCompanionBlock(), buildGridTemplateInstruction(), buildGuidedGridEditAnchorBlock(), buildGuidedGridReminderBlock(), buildGuidedLayoutOverrideBlock(), buildSafeFramingInstruction() (+55 more)
...
Cohesion: 0.60
Nodes (4): decodePngToRgba(), useExport(), jszip, loadImagesData()
...
Cohesion: 0.67
Nodes (4): buildStickerVoicePromptBlock(), listStickerVoiceKeys(), resolveStickerVoice(), STICKER_VOICE_PRESETS
...
Cohesion: 0.14
Nodes (23): focusRing, SheetSliceProgrammaticOverlayPanelProps, ColorKey, createEmptyOverlaySheetArray(), FontKey, LineStickerProgrammaticOverlayComposeResult, LineStickerProgrammaticOverlayCore, LineStickerProgrammaticOverlayStyle (+15 more)

### Community 144 - "uploadConfig.self-check.mts"
Cohesion: 0.39
Nodes (5): useComicStoryboard(), generateComicStoryboard(), parseComicStoryboardJson(), StoryboardEntry, clampComicDialogue()
...
- **Why does `jszip` connect `programmaticTextOverlay.mts` to `Sprite Editing UI`, `LINE Upload Packaging`, `Project Dependencies`?**
  _High betweenness centrality (0.053) - this node is a cross-community bridge._
- **Why does `dependencies` connect `Project Dependencies` to `programmaticTextOverlay.mts`?**
  _High betweenness centrality (0.052) - this node is a cross-community bridge._
- **Why does `useExport()` connect `programmaticTextOverlay.mts` to `useExport`, `Sprite Sheet Processing`, `Grid Score Gating`, `SpriteAnimatorPage.tsx`?**
