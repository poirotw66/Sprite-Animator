 ...
 */
export const LINE_STICKER_CELL_INSET_RATIO = 0.01;
...
/** Default chroma removal shared by the browser and headless production pipeline. */
export const DEFAULT_CHROMA_KEY_ALGORITHM: ChromaKeyAlgorithm = 'core';
